...
- Phase 0 through Phase 8 gates are implemented and verified.
...
- Pong, Arkanoid, the full playground, source editing, full live PTY game proof,
  and benchmarks remain later-phase work.
